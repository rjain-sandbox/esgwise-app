      ...
      <main id="main-content" className="mx-auto max-w-3xl px-6 pb-24 pt-12">
        <div className="mb-10">
          <p className="font-mono text-xs uppercase tracking-[0.2em] text-muted-foreground">
            Tool 04 · Carbon Footprint
          </p>
          <h1 className="mt-3 font-display text-4xl font-semibold tracking-tight sm:text-5xl">
            Measure the carbon weight of your lifestyle.
          </h1>
          <p className="mt-4 max-w-2xl text-base text-muted-foreground">
            Twelve questions across four areas — Living, Mobility, Transportation
            and Consumption. Unlike the Handprint, here a lower score is the goal.
          </p>
        </div>
        ...
        >
                      ...
                      >
                        ...
                        <div className="flex items-center gap-4">
                          <input
                            ...
                            aria-valuetext={`${answers[q.id]} out of 10`}
          ...
          <div className="mt-10 flex flex-col items-start gap-4 sm:flex-row sm:items-center sm:justify-between">
            <p className="text-sm text-muted-foreground">
              Adjust each slider, then reveal your footprint weight.
            </p>
            <button
              type="submit"
              className="inline-flex min-h-11 items-center justify-center rounded-full bg-primary px-6 py-3 text-sm font-medium text-primary-foreground shadow-sm transition hover:bg-primary/90"
            >
              See my footprint →
            </button>
          </div>
      ...
      <main id="main-content" className="mx-auto max-w-3xl px-6 pb-24 pt-12">
        ...
        >
          ...
          <div
            ...
            role="img"
            aria-label={`Footprint score ${result.normalized} out of 10`}
          >
            <div
          ...
          <p className="mt-4 font-mono text-xs opacity-70">
            Raw carbon points: {result.rawTotal} / 120
          </p>
        </section>

        <section aria-labelledby="area-heading" className="mt-12">
          <h2 id="area-heading" className="font-display text-2xl font-semibold">
            Where your weight comes from
          </h2>
              ...
              >
                ...
                <dd className="mt-1 flex items-baseline gap-2">
                  <span className="font-display text-3xl font-semibold tabular-nums">
                    {result.areaScores[area.id]}
                  </span>
                  <span className="font-mono text-xs text-muted-foreground">/ 10</span>
                </dd>
                <p className="mt-1 text-sm text-foreground">{area.name}</p>
              </div>
            ))}
          </dl>
        </section>
