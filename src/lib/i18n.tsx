...
export const dict = {
  ...
  "sroi.perDollar": { en: "per $1 invested", de: "pro 1 € investiert" },
  "sroi.rawTotal": { en: "Raw total", de: "Rohwert" },
  "sroi.toScore": { en: "÷ 20 → impact score", de: "÷ 20 → Wirkungswert" },
  "sroi.pillarBreakdown": { en: "Pillar breakdown", de: "Aufschlüsselung nach Säulen" },
  ...
  "sroi.pillar.environmental": { en: "Environmental", de: "Ökologisch" },
  "sroi.pillar.innovation": { en: "Innovation & Transparency", de: "Innovation & Transparenz" },
  // SROI tier labels
  ...
  // SROI questions
  "sroi.q.capital.label": { en: "Capital Commitment", de: "Kapitaleinsatz" },
  "sroi.q.capital.helper": { en: "Total dollar amount of the investment (USD).", de: "Gesamtbetrag der Investition (€)." },
  "sroi.q.roi.label": { en: "Projected Financial Return", de: "Erwartete finanzielle Rendite" },
  "sroi.q.roi.helper": { en: "Expected annual financial ROI (%).", de: "Erwartete jährliche Rendite (%)." },
  "sroi.q.jobs.label": { en: "Local Job Creation", de: "Lokale Arbeitsplatzschaffung" },
  "sroi.q.jobs.helper": { en: "FTE roles created in underserved communities.", de: "Vollzeitstellen, die in unterversorgten Gemeinden geschaffen werden." },
  "sroi.q.wage.label": { en: "Living Wage Commitment", de: "Existenzlohn-Verpflichtung" },
  "sroi.q.wage.helper": { en: "% of employees paid a living wage (vs. local minimum).", de: "% der Mitarbeitenden mit Existenzlohn (statt Mindestlohn)." },
  "sroi.q.upskill.label": { en: "Upskilling & Growth", de: "Weiterbildung & Wachstum" },
  "sroi.q.upskill.helper": { en: "Formal technical certifications or training programmes.", de: "Formale Fachzertifikate oder Schulungsprogramme." },
  "sroi.q.carbon.label": { en: "Carbon Displacement", de: "CO₂-Vermeidung" },
  "sroi.q.carbon.helper": { en: "Does the product reduce CO₂ or replace a high-carbon alternative?", de: "Senkt das Produkt CO₂ oder ersetzt es eine emissionsintensive Alternative?" },
  "sroi.q.circular.label": { en: "Resource Efficiency", de: "Ressourceneffizienz" },
  "sroi.q.circular.helper": { en: "Use of circular-economy principles (recycling / waste reduction).", de: "Anwendung von Kreislaufwirtschaftsprinzipien (Recycling / Abfallreduktion)." },
  "sroi.q.ownership.label": { en: "Community Ownership", de: "Gemeinschaftsbeteiligung" },
  "sroi.q.ownership.helper": { en: "Profit-sharing or equity for local communities / employees.", de: "Gewinnbeteiligung oder Anteile für Gemeinden / Mitarbeitende." },
  "sroi.q.innovation.label": { en: "Innovation Level", de: "Innovationsgrad" },
  "sroi.q.innovation.helper": { en: "Solves a social problem previously unaddressed in this region.", de: "Löst ein soziales Problem, das in der Region zuvor unbeachtet war." },
  "sroi.q.transparency.label": { en: "Impact Transparency", de: "Wirkungstransparenz" },
  "sroi.q.transparency.helper": { en: "KPIs audited or tracked via a transparent digital ledger.", de: "KPIs geprüft oder über ein transparentes digitales Register verfolgt." },
